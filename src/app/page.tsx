...
<div className="video-container w-[80%] h-[50vh] mx-auto my-5">
  ...
  />
    ...
    <div className="flex justify-center mt-32 text-center w-auto">
      <h1
        ref={titleRef}
    ...
    <div>
        <div className="min-w-0 p-4 text-center bg-white border  rounded-lg shadow sm:p-8 dark:bg-yellow-500 ">
                <h5 className="mb-2 text-3xl font-bold text-gray-900 dark:text-white">Entra a far parte del Futuro</h5>
                <p className="mb-5 text-base text-black  sm:text-lg dark:text-white">Fissa un appuntamento per discutere del progetto migliore per le tue esigenze</p>
                <div className="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
                <a href="mailto:info@futurea.com" className=" sm:w-auto bg-yellow-800 hover:bg-yellow-700 focus:ring-4 focus:outline-none focus:ring-yellow-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-yellow-700 dark:hover:bg-yellow-600 dark:focus:ring-yellow-700">
                ...
                <a href="#" className=" sm:w-auto bg-yellow-800 hover:bg-yellow-700 focus:ring-4 focus:outline-none focus:ring-yellow-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-yellow-700 dark:hover:bg-yellow-600 dark:focus:ring-yellow-700">
